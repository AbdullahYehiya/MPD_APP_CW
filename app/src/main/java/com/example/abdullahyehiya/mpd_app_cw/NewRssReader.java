...
public class NewRssReader extends AsyncTask<Void,Void,Void> {

    Context mContext;
    String address = "http://trafficscotland.org/rss/feeds/plannedroadworks.aspx";
    ProgressDialog progressDialog;
    ArrayList<RssItems> rssItems;
    RecyclerView recyclerView;
    URL url;

    public NewRssReader(Context context,RecyclerView recyclerView) {
        ...
        if (data != null) {
            ...
            for (int i=0;i<items.getLength();i++){
                ...
                if (currentchild.getNodeName().equalsIgnoreCase("item")){
                    ...
                    rssItems.add(item);
                    Log.d("Data Record",rssItems.toString());
